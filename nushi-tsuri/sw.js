const CACHE_NAME = "nushi-tsuri-v138-mebaru-life-motion-138-1";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./assets/fish-mebaru-v138.png",
  "./assets/fish-mebaru-mouth-part-v138.png",
  "./assets/fish-mebaru-mouth-open-v138.png",
  "./assets/fish-mebaru-turn-v138.png",
