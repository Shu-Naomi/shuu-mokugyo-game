const CACHE_NAME = "nushi-tsuri-v143-mebaru-visible-143-1";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./assets/fish-mebaru-v143.png",
  "./assets/fish-mebaru-mouth-part-v143.png",
  "./assets/fish-mebaru-mouth-open-v143.png",
  "./assets/fish-mebaru-turn-v143.png",
