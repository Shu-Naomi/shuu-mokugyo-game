const CACHE_NAME = "nushi-tsuri-v139-mebaru-visible-css-atlas-139-1";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./assets/fish-mebaru-v139.png",
  "./assets/fish-mebaru-mouth-part-v139.png",
  "./assets/fish-mebaru-mouth-open-v139.png",
  "./assets/fish-mebaru-turn-v139.png",
