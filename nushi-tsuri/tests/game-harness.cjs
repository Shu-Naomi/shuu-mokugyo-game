...
const html = fs.readFileSync(path.join(__dirname, "../index.html"), "utf8")
  .replace(/<script src="((?:ui-feedback|event-ceremony|fortune-capsules|aquarium-life|pet-life(?:-ui)?|pixel-(?:world|cast)|weather|rival-anglers|tournament(?:-npcs)?|music-tracks|soundscape|scene-layers|layered-scenery)\.js)\?[^\"]+"><\/script>/g,
